...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <div style="margin-left: 700px;">
            ...
            <a href="../pasien/add.php" class="btn btn-success btn-icon-split">
                        ...
                        while($data = mysqli_fetch_array($sql_poli)) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="add.php?id=<?=$data['id_pasien']?>" class="badge bg-success text-light"><i class="fas fa-plus"></i> Registrasi</a>
