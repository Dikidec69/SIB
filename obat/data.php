                        ...
                        while($data = mysqli_fetch_array($sql_obat)) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="edit.php?id=<?=$data['id_obat']?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                    <a href="del.php?id=<?=$data['id_obat']?>" data-toggle="modal" data-target="#hapusModal" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-danger" href="del.php?id=<?=$data['id_obat']?>">Yakin</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
