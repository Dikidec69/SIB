        ...
        <h6 class="m-0 font-weight-bold text-primary">Tambah Poliklinik</h6>
            ...
            ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8" >
                    <input type="text" class="form-control" name="id_poli" id="id_poli" value="<?=$data['id_poli']?>" required autofocus autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="nama_poli" class="col-sm-3 col-form-label">Nama Poliklinik</label>
                    <div class="col-sm-8" >
                    <input type="text" class="form-control" name="nama_poli" id="nama_poli" value="<?=$data['nama_poli']?>" required autofocus autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="jadwal" class="col-sm-3 col-form-label">Hari Buka</label>
                    <div class="col-sm-8" >
                    <input type="text" class="form-control" name="jadwal" id="jadwal" value="<?=$data['jadwal']?>" required autofocus autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="jam_buka" class="col-sm-3 col-form-label">Jam Buka</label>
                    <div class="col-sm-8" >
                    <input type="text" class="form-control" name="jam_buka" id="jam_buka" value="<?=$data['jam_buka']?>" required autofocus autocomplete="off">
                    </div>
                </div>
