...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Poliklinik</h6>
                        ...
                        while($data = mysqli_fetch_array($sql_poli)) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="edit.php?id=<?=$data['id_poli']?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                    <a href="del.php?id=<?=$data['id_poli']?>" data-toggle="modal" data-target="#hapusModal" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-danger" href="del.php?id=<?=$data['id_poli']?>">Yakin</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
if(@$_POST['pencarian'] == '') { ?>
    ...
    echo "Jumlah Poliklinik : <b>$jml</b>";
    ?>
    </div>
