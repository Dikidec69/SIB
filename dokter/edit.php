        ...
        <h6 class="m-0 font-weight-bold text-primary">Edit Data Dokter</h6>
            ...
            ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8" >
                    <input type="text" class="form-control" name="nama_dokter" id="nama_dokter" value="<?=$data['nama_dokter']?>" required autofocus autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <select class="form-control" name="id_poli" id="id_poli" required autocomplete="off">
                        <option value="<?=$data['id_poli']?>"><?=$data['id_poli']?></option>
                        <?php
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control" name="spesialis" id="spesialis" value="<?=$data['spesialis']?>" required autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="no_telp" class="col-sm-3 col-form-label">Nomor Telephone</label>
                    <div class="col-sm-8">
                    <input type="number" class="form-control" name="no_telp" id="no_telp" value="<?=$data['no_telp']?>" required autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="alamat" class="col-sm-3 col-form-label">Alamat</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" name="alamat" id="alamat" value="<?=$data['alamat']?>" required autocomplete="off">
                    </div>
                </div>
